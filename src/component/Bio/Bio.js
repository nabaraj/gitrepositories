                    ...
                    <div className="mediaContent">
                        ...
                        <div className="blurBg">
                            <div className="bioHeaderContainer">
                                <Avatar alt="Remy Sharp" className="MuiAvatar-rounded" src={bioData.avatar_url} />
                    ...
                    <CardContent>
                        ...
                        <div className="header-chips">
                            <Chip
                                ...
                                size="small"
                                avatar={<Avatar className="MuiAvatar-rounded">{bioData.public_repos}</Avatar>}
                                label="Public Repos"
                            ...
                            <Chip
                                ...
                                className="MuiChip-rounded"
                                size="small"
                                avatar={<Avatar className="MuiAvatar-rounded">{bioData.following}</Avatar>}
                                label="Following"
                            ...
                            <Chip
                                ...
                                className="MuiChip-rounded"
                                size="small"
                                avatar={<Avatar className="MuiAvatar-rounded">{bioData.public_gists}</Avatar>}
                                label="Public Gists"
                            ...
                            <Chip
                                ...
                                size="small"
                                variant="outlined"
                                avatar={<Avatar className="MuiAvatar-rounded">{bioData.followers}</Avatar>}
                                label="Followers"
